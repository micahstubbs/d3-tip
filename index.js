  ...
  return function() {
    ...
    tip.show = function() {
      ...
      var content = html.apply(this, args),
          ...
          i       = directions.length,
          coords,
          parentsCoords = node.offsetParent.getBoundingClientRect()
      ...
      nodel.classed(dir, true)
      	.style('top', (coords.top + poffset[0]) - parentsCoords.top + 'px')
      	.style('left', (coords.left + poffset[1]) - parentsCoords.left + 'px')
